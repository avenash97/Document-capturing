...
if __name__=="__main__":
    ...
    parser.add_argument('--image_path',help='Path to the image',type=str,default="check.jpg")
    parser.add_argument('--window_size',help='window size of filter',type=int,default=7)
    parser.add_argument('--method',help='Type of algo to be used (shitomasi,harris,both)',type=str,default="shitomasi")
    ...
    parser.add_argument('--thresholdS',help='threshold for cornerness score in Shi-Tomasi Corner Detector',type=float,default=0.0001)
    args = parser.parse_args()

    img = readimg(args.image_path)
    original = cv.resize(cv.imread(args.image_path,1),(250,250))
